...
public class Util {
    ...
    public static String getHostName() {
        try {
            ...
            final Process process = run.exec("hostname");
    ...
    public static void packUnsignedLong(long value, final DataOutput buffer) throws IOException {
    ...
    public static long unpackUnsignedLong(final DataInput buffer) throws IOException {
        int shift = 0;
        long result = 0;
        while (shift < 64) {
    ...
    public static void packLong(final long value, final DataOutput buffer) throws IOException {
        // Great trick from http://code.google.com/apis/protocolbuffers/docs/encoding.html#types
        packUnsignedLong((value << 1) ^ (value >> 63), buffer);

    }

    public static long unpackLong(final DataInput buffer) throws IOException {
        final long value = unpackUnsignedLong(buffer);
    ...
    private static boolean isGoodV4Address(final InetAddress address) {
    ...
    private static boolean isGoodV6Address(final InetAddress address) {
     ...
     */
    public static long getSamplingDuration(final long timestamp, final Sampling sampling, final DateTimeZone timeZone) {
        long ret = sampling.getValue();
        final DateTime dt = new DateTime(timestamp, timeZone);
