...
public class GuiceKairosDataPointFactory implements KairosDataPointFactory {
    ...
    @Inject
    public GuiceKairosDataPointFactory(final Injector injector, final Properties props) {
     ...
     */
    @Override
    public DataPoint createDataPoint(final String dataStoreType, final long timestamp, final DataInput buffer) throws IOException {
