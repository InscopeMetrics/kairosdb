...
public class RateAggregator implements Aggregator, TimezoneAware {
    ...
    @Inject
    public RateAggregator(final DoubleDataPointFactory dataPointFactory) {
    ...
    private class RateDataPointAggregator extends AggregatedDataPointGroupWrapper {
        RateDataPointAggregator(final DataPointGroup innerDataPointGroup) {
        ...
        public DataPoint next() {
            ...
            final double rate = (x1 - x0) / (y1 - y0) * Util.getSamplingDuration(y0, m_sampling, m_timeZone);
