...
public class CoreModule extends AbstractModule {
    ...
    public CoreModule(final Properties props) {
        m_props = props;
    ...
    private Class getClassForProperty(final String property) {
        final String className = m_props.getProperty(property);
    ...
    protected void configure() {
        ...
        final String hostname = m_props.getProperty("kairosdb.hostname");
        ...
        final String hostIp = m_props.getProperty("kairosdb.host_ip");
