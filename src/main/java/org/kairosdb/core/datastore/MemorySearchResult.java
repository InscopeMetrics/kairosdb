...
public class MemorySearchResult implements SearchResult {
    ...
    public MemorySearchResult(final String metricName) {
    ...
    public DataPointWriter startDataPointSet(final String dataType, final SortedMap<String, String> tags) throws IOException {
        final MemoryDataPointRow currentRow = new MemoryDataPointRow(dataType, tags);
    ...
    private class MemoryDataPointWriter implements DataPointWriter {
        ...
        public MemoryDataPointWriter(final MemoryDataPointRow currentRow) {
    ...
    private class MemoryDataPointRow implements DataPointRow {
        ...
        private MemoryDataPointRow(final String dataType, final Map<String, String> tags) {
            m_dataType = dataType;
            m_tags = tags;
