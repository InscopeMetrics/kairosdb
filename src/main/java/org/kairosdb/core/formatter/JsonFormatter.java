...
public class JsonFormatter implements DataFormatter {
    @Override
    public void format(final Writer writer, final Iterable<String> iterable) throws FormatterException {
        checkNotNull(writer);
    ...
    @Override
    public void format(final Writer writer, final List<List<DataPointGroup>> data) throws FormatterException {
        ...
        try {
            ...
            for (final List<DataPointGroup> groups : data) {
                jsonWriter.object().key("results").array();
