...
/**
*/
public class MetricTagValuesQuery extends org.agileclick.genorm.runtime.SQLQuery
	{
	...
	//Deprecated
	public MetricTagValuesQuery()
		{
		super();
		}		
	//---------------------------------------------------------------------------
	public MetricTagValuesQuery(String metricName, String tagName)
		{
		super();
	...
	public void serializeQuery(ContentHandler ch, String tagName)
		...
		while (rs.next())
			{
			MetricTagValuesData rec = rs.getRecord();
	...
	//---------------------------------------------------------------------------
	//Deprecated
	public ResultSet runQuery(String metricName, String tagName)
		{
	...
	public ResultSet runQuery()
		...
		try
			...
			genorm_statement.setString(2, m_tagName);
	...
	//===========================================================================
	public interface ResultSet extends GenOrmQueryResultSet<MetricTagValuesData>
		{
		public List<MetricTagValuesData> getArrayList(int maxRows);
		public List<MetricTagValuesData> getArrayList();
		public MetricTagValuesData getRecord();
		public MetricTagValuesData getOnlyRecord();
		}
	...
	private class SQLResultSet 
		...
		*/
		public List<MetricTagValuesData> getArrayList(int maxRows)
			{
			ArrayList<MetricTagValuesData> results = new ArrayList<MetricTagValuesData>();
			int count = 0;
			...
			try
				...
				if (m_onFirstResult)
					{
					count ++;
					results.add(new MetricTagValuesData(MetricTagValuesQuery.this, m_resultSet));
					}
		...
		*/
		public MetricTagValuesData getRecord()
			{
			MetricTagValuesData ret = null;
			try
				{
				ret = new MetricTagValuesData(MetricTagValuesQuery.this, m_resultSet);
				}
			catch (java.sql.SQLException sqle)
				{
				throw new GenOrmException(sqle);
		...
		*/
		public MetricTagValuesData getOnlyRecord()
			...
			try
				...
				if (m_resultSet.next())
					throw new GenOrmException("Multiple rows returned in call from MetricTagValuesQuery.ResultSet.getOnlyRecord");
				}
			catch (java.sql.SQLException sqle)
				{
				throw new GenOrmException(sqle);
	...
	public class Record implements GenOrmQueryRecord, Attributes
		...
		protected Record(java.sql.ResultSet rs)
			...
			if (m_serializable)
				...
				m_attrValues[0] = MetricTagValuesQuery.this.m_formatter.toString(s_attributeNames[0], m_tagValue);
