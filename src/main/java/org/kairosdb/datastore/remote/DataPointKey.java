...
public class DataPointKey {
    ...
    public DataPointKey(final String name, final ImmutableSortedMap<String, String> tags, final String type, final int ttl) {
        m_name = name;
        m_tags = tags;
        m_type = type;
        m_ttl = ttl;
    ...
    public boolean equals(final Object o) {
        ...
        final DataPointKey that = (DataPointKey) o;
