...
public class CassandraClientImpl implements CassandraClient, KairosPostConstructInit {
    ...
    public void init() {
        ...
        final TokenAwarePolicy readLoadBalancePolicy = new TokenAwarePolicy((m_clusterConfiguration.getLocalDCName() == null) ? new RoundRobinPolicy() : DCAwareRoundRobinPolicy.builder().withLocalDc(m_clusterConfiguration.getLocalDCName()).build(), true);
