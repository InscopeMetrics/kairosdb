...
public class ClusterConnection {
    ...
    public ClusterConnection(final CassandraClient cassandraClient, final EnumSet<Type> clusterType) {
    ...
    private void setupSchema(final CassandraClient cassandraClient, EnumSet<Type> clusterType) {
