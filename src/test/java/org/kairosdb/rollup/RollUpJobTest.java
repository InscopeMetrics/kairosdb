...
public class RollUpJobTest {
    ...
    public void test_getLastRollupDataPoint() throws ParseException, DatastoreException {
        ...
        final List<DataPoint> localhostDataPoints = new ArrayList<DataPoint>();
        ...
        final List<DataPoint> remoteDataPoints = new ArrayList<DataPoint>();
    ...
    public static class TestDatastore implements Datastore {
        ...
        public void putDataPoints(final String metricName, final ImmutableSortedMap<String, String> tags, final List<DataPoint> dataPoints) throws DatastoreException {
        ...
        @Override
        public void deleteDataPoints(final DatastoreMetricQuery deleteQuery) throws
                DatastoreException {
            throw new UnsupportedOperationException();
        }

        @Override
        public TagSet queryMetricTags(final DatastoreMetricQuery query) throws
                DatastoreException {
            throw new UnsupportedOperationException();
        }
