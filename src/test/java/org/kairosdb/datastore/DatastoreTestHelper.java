...
public abstract class DatastoreTestHelper {
    ...
    private static List<String> listFromIterable(final Iterable<String> iterable) {
    ...
    private static SetMultimap<String, String> extractTags(final DataPointGroup dpGroup) {
        final SetMultimap<String, String> resp = TreeMultimap.create();

        for (final String tag : dpGroup.getTagNames()) {
            for (final String value : dpGroup.getTagValues(tag)) {
                resp.put(tag, value);
            }
        }
    ...
    protected static void loadData() throws DatastoreException {
        ...
        final Publisher<DataPointEvent> publisher = s_eventBus.createPublisher(DataPointEvent.class);
    ...
    public void test_getMetricNames() throws DatastoreException {
        final List<String> metrics = listFromIterable(s_datastore.getMetricNames(null));
    ...
    public void test_getMetricNames_with_prefix() throws DatastoreException {
        final List<String> metrics = listFromIterable(s_datastore.getMetricNames("m"));
    ...
    public void test_queryDatabase_noTags() throws DatastoreException {
        ...
        final QueryMetric query = new QueryMetric(s_startTime, 0, "metric1");
        query.setEndTime(s_startTime + 3000);

        query.setTags(tags);

        final DatastoreQuery dq = s_datastore.createQuery(query);
        ...
        try {
            ...
            final SetMultimap<String, String> resTags = extractTags(dpg);

            assertThat(resTags.size(), is(5));
            final SetMultimap<String, String> expectedTags = TreeMultimap.create();
    ...
    public void test_duplicateDataPoints() throws DatastoreException {
        final SetMultimap<String, String> tags = HashMultimap.create();
        final QueryMetric query = new QueryMetric(s_startTime, 0, "duplicates");
        query.setEndTime(s_startTime + 3000);
    ...
    public void test_queryDatabase_noResults() throws DatastoreException {
        ...
        final Map<String, String> tags = new TreeMap<>();
        final QueryMetric query = new QueryMetric(500, 0, "metric1");
    ...
    public void test_queryNegativeAndPositiveTime() throws DatastoreException {
        final QueryMetric query = new QueryMetric(-2000000000L, 0, "old_data");
    ...
    public void test_queryWithUnicode() throws DatastoreException {
        final SetMultimap<String, String> tags = HashMultimap.create();
        final QueryMetric query = new QueryMetric(s_startTime, 0, s_unicodeNameWithSpace);
        query.setEndTime(s_startTime + 3000);
    ...
    public void test_notReturningTagsForEmptyData() throws DatastoreException, InterruptedException {
        final QueryMetric query = new QueryMetric(s_startTime - 1, 0, "delete_me");
    ...
    private void assertValues(final DataPointGroup group, final long... values) {
        for (final long expected : values) {
            assertThat(group.hasNext(), is(true));
            final long actual = group.next().getLongValue();
