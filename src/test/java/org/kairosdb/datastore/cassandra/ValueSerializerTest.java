...
public class ValueSerializerTest {
    ...
    private void testValue(final long value) throws IOException {
        final KDataOutput bufOutput = new KDataOutput();
        packLong(value, bufOutput);

        final DataInput bufInput = KDataInput.createInput(bufOutput.getBytes());
        final long resp = unpackLong(bufInput);
