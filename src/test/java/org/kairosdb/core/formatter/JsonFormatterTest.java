...
public class JsonFormatterTest {
    ...
    public void test_format() throws FormatterException {
        final List<DataPointGroup> metric1 = new ArrayList<DataPointGroup>();

        final ListDataPointGroup group1 = new ListDataPointGroup("group1");
        ...
        final List<DataPointGroup> metric2 = new ArrayList<DataPointGroup>();

        final ListDataPointGroup group2 = new ListDataPointGroup("group2");
        ...
        final List<List<DataPointGroup>> results = new ArrayList<List<DataPointGroup>>();
        results.add(metric1);
        results.add(metric2);
    ...
    public void test_format_withGroupBy() throws FormatterException {
        ...
        final Map<String, String> tagResults = new LinkedHashMap<String, String>();
