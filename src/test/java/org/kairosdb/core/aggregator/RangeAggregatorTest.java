...
public class RangeAggregatorTest {
    ...
    public void test_yearAggregationWithoutLeapYears() {
        ...
        final ListDataPointGroup dpGroup = new ListDataPointGroup("range_test");

        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, utc);
        ...
        final SumAggregator agg = new SumAggregator(new DoubleDataPointFactoryImpl());
        agg.setSampling(new Sampling(1, TimeUnit.YEARS));
        agg.setAlignSampling(false);
        agg.setStartTime(startDate.getMillis());

        final DataPointGroup aggregated = agg.aggregate(dpGroup);
    ...
    public void test_multipleMonthAggregationWithUTC() {
        ...
        final DateTime stopDate = new DateTime(2014, 7, 10, 1, 1, utc);
    ...
    public void test_aggregateByMonthStartAtMidMonthDontAlign() {
        ...
        final DateTime startDate = new DateTime(2014, 3, 10, 0, 0, utc);
        final DateTime stopDate = new DateTime(2014, 5, 23, 0, 0, utc);
        for (DateTime iterationDT = startDate;
             iterationDT.isBefore(stopDate);
             iterationDT = iterationDT.plusDays(1)) {
            dpGroup.addDataPoint(new LongDataPoint(iterationDT.getMillis(), 1));
        ...
        final DataPointGroup aggregated = aggregator.aggregate(dpGroup);

        assertThat(aggregated.hasNext(), is(true));
        final DataPoint marchDataPoint = aggregated.next();
        assertThat(new DateTime(marchDataPoint.getTimestamp(), utc), equalTo(startDate));
        assertThat(marchDataPoint.getLongValue(), is(31L));

        assertThat(aggregated.hasNext(), is(true));
        final DataPoint aprilDataPoint = aggregated.next();
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DataPoint mayMonthDataPoint = aggregated.next();
    ...
    public void test_aggregateByMonthStartAtMidMonthAlignEnd() {
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DateTime marchFirst = new DateTime(2014, 4, 1, 0, 0, utc);
        final DataPoint marchDataPoint = aggregated.next();
        assertThat(new DateTime(marchDataPoint.getTimestamp(), utc), equalTo(marchFirst));
        assertThat(marchDataPoint.getLongValue(), is(22L));

        assertThat(aggregated.hasNext(), is(true));
        final DateTime aprilFirst = new DateTime(2014, 5, 1, 0, 0, utc);
        final DataPoint aprilDataPoint = aggregated.next();
        assertThat(new DateTime(aprilDataPoint.getTimestamp(), utc), equalTo(aprilFirst));
        assertThat(aprilDataPoint.getLongValue(), is(30L));

        assertThat(aggregated.hasNext(), is(true));
        final DateTime mayFirst = new DateTime(2014, 6, 1, 0, 0, utc);
        final DataPoint mayMonthDataPoint = aggregated.next();
        assertThat(new DateTime(mayMonthDataPoint.getTimestamp(), utc), equalTo(mayFirst));
        assertThat(mayMonthDataPoint.getLongValue(), is(22L));
    ...
    public void test_aggregationByWeekAlign() {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2015, 1, 2, 1, 11, utc);
        final DateTime endDate = new DateTime(2015, 1, 18, 11, 11, utc);
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DateTime firstWeekStart = new DateTime(2014, 12, 29, 0, 0, utc);
        final DataPoint firstWeekDataPoint = aggregated.next();
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DateTime secondWeekStart = new DateTime(2015, 1, 5, 0, 0, utc);
        final DataPoint secondWeekDataPoint = aggregated.next();
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DateTime thirdWeekStart = new DateTime(2015, 1, 12, 0, 0, utc);
        final DataPoint thirdWeekDataPoint = aggregated.next();
    ...
    public void test_aggregationByWeekAlignEnd() {
        ...
        assertThat(aggregated.hasNext(), is(true));
        final DateTime firstWeekStart = new DateTime(2015, 1, 5, 0, 0, utc);
        final DataPoint firstWeekDataPoint = aggregated.next();
        assertThat(new DateTime(firstWeekDataPoint.getTimestamp(), utc), equalTo(firstWeekStart));
        assertThat(firstWeekDataPoint.getLongValue(), is(3L));

        assertThat(aggregated.hasNext(), is(true));
        final DateTime secondWeekStart = new DateTime(2015, 1, 12, 0, 0, utc);
        final DataPoint secondWeekDataPoint = aggregated.next();
        assertThat(new DateTime(secondWeekDataPoint.getTimestamp(), utc), equalTo(secondWeekStart));
        assertThat(secondWeekDataPoint.getLongValue(), is(7L));

        assertThat(aggregated.hasNext(), is(true));
        final DateTime thirdWeekStart = new DateTime(2015, 1, 19, 0, 0, utc);
        final DataPoint thirdWeekDataPoint = aggregated.next();
        assertThat(new DateTime(thirdWeekDataPoint.getTimestamp(), utc), equalTo(thirdWeekStart));
        assertThat(thirdWeekDataPoint.getLongValue(), is(7L));
    ...
    public void test_aggregationByHourOverMarch_dst() {
        final ListDataPointGroup group = new ListDataPointGroup("March");
        final DateTimeZone paris = DateTimeZone.forID("Europe/Paris");
        ...
        final DataPointGroup hourCount = aggregator.aggregate(group);
    ...
    public void test_aggregationByHourOverOctober_dst() {
        final ListDataPointGroup group = new ListDataPointGroup("October");
        final DateTimeZone paris = DateTimeZone.forID("Europe/Paris");
    ...
    public void test_aggregationByYearOverLeapYears() {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2010, 1, 1, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 1, 0, 0, utc);
        ...
        final DataPointGroup dayCount = aggregator.aggregate(dpGroup);
    ...
    public void test_aggregationByDay() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 3, 3, 0, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
        ...
        final DataPointGroup dayCount = aggregator.aggregate(group);
    ...
    public void test_aggregationByHour() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 1, 2, 20, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
    ...
    public void test_aggregationByMinute() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 1, 0, 2, 20, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
    ...
    public void test_aggregationBySecond() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 1, 0, 0, 2, 200, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
    ...
    public void test_aggregationByMilliSecond() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 1, 1, 0, 0, 0, 3, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
    ...
    public void test_aggregationByMilliSecondOverLongRange() throws Exception {
        final DateTimeZone utc = DateTimeZone.UTC;
        final DateTime startDate = new DateTime(2014, 1, 1, 0, 0, 0, 0, utc);
        final DateTime endDate = new DateTime(2014, 3, 1, 0, 0, 0, 0, utc);
        final ListDataPointGroup group = new ListDataPointGroup("aggregationByDay");
        ...
        final DataPointGroup dpg = aggregator.aggregate(group);
