...
public class SaveAsAggregatorTest {
    ...
    public void testTtl() throws DatastoreException {
        ...
        final DataPointGroup results = m_aggregator.aggregate(group);
    ...
    public void testNotAddingSavedFrom() throws DatastoreException {
        ...
        final ImmutableSortedMap<String, String> verifyMap = ImmutableSortedMap.<String, String>naturalOrder()
                .put("sweet_tag", "value")
                .build();
    ...
    public void testGroupByTagFilter() throws DatastoreException {
        ...
        final GroupBy groupBy = new TagGroupBy("host", "host2");
