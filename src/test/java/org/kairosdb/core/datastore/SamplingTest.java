...
public class SamplingTest {
    ...
    public void test_getUnitDuration_year_no_leap() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.YEARS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_year_over_leap() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.YEARS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2012, 2, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_month_january() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.MONTHS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 1, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_month_february() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.MONTHS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 2, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_week() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.WEEKS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_day() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.DAYS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_minute() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.MINUTES);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_seconds() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.SECONDS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
    ...
    public void test_getUnitDuration_milliseconds() throws Exception {
        final Sampling sampling = new Sampling(1, TimeUnit.MILLISECONDS);
        final DateTimeZone timezone = DateTimeZone.forID("Europe/Brussels");
        final DateTime dt = new DateTime(2014, 12, 18, 1, 2, 3, 4, timezone);
