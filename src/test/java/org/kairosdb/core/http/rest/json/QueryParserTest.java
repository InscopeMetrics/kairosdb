...
public class QueryParserTest {
    ...
    public void test_absolute_dates() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-absolute-dates-with-groupby.json"), Charsets.UTF_8);

        final List<QueryMetric> results = parser.parseQueryMetric(json).getQueryMetrics();

        assertThat(results.size(), equalTo(1));

        final QueryMetric queryMetric = results.get(0);
    ...
    public void test_absolute_date_overrides() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-absolute-dates-with-override.json"), Charsets.UTF_8);
    ...
    public void test_withNoAggregators() throws Exception {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-no-aggregators.json"), Charsets.UTF_8);
    ...
    public void test_noName() throws Exception {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-no-name.json"), Charsets.UTF_8);
    ...
    public void test_noTags() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-no-tags.json"), Charsets.UTF_8);
    ...
    public void test_oneTag() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-one-tag.json"), Charsets.UTF_8);
    ...
    public void test_twoTags() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-two-tags.json"), Charsets.UTF_8);
    ...
    public void test_excludeTags() throws Exception {
        final String json = Resources.toString(Resources.getResource("query-metric-exclude-tags.json"), Charsets.UTF_8);
    ...
    public void test_cacheTime_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-cache-time.json"), Charsets.UTF_8);
    ...
    public void test_no_start_time_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-no-start_date.json"), Charsets.UTF_8);
    ...
    public void test_absoluteStartTime_before_epoch_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("query-metric-start_absolute-before-epoch.json"), Charsets.UTF_8);
        parser.parseQueryMetric(json);
    }

    @Test
    public void test_relativeStartTime_before_epoch_valid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("query-metric-relative-startTime-before-epoch.json"), Charsets.UTF_8);
        parser.parseQueryMetric(json);
    }

    @Test
    public void test_absoluteEndTime_before_startTime_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-absoluteEndTime-less-than-startTime.json"), Charsets.UTF_8);
    ...
    public void test_relativeEndTime_before_startTime_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-relativeEndTime-less-than-startTime.json"), Charsets.UTF_8);
    ...
    public void test_relativeStartTime_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-relative-startTime-value.json"), Charsets.UTF_8);
    ...
    public void test_relativeEndTime_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-relative-endTime-value.json"), Charsets.UTF_8);
    ...
    public void test_missingMetric_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-no-metric.json"), Charsets.UTF_8);
    ...
    public void test_nullTagValueInArray_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("query-metric-null-tag-value-in-array.json"), Charsets.UTF_8);
    ...
    public void test_emptyTagName_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-tag-empty-name.json"), Charsets.UTF_8);
    ...
    public void test_emptyTagValueInArray_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-tag-empty-value-in-array.json"), Charsets.UTF_8);
    ...
    public void test_nullTagValue_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("query-metric-null-tag-value.json"), Charsets.UTF_8);
    ...
    public void test_emptyTagValue_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-tag-empty-value.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_missingName_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-no-name.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_emptyName_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-empty-name.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_sampling_value_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-sampling-value.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_sampling_timezone_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-sampling-timezone.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_sum_noSampling_valid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-sum-no-sampling.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_div_no_divisor_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-div-no-divisor.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_div_divisor_zero_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-div-divisor-zero.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_percentile_no_percentile_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-percentile-no-percentile.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_percentile_percentile_zero_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-percentile-percentile-zero.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_percentile_percentile_numberFormat_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-percentile-percentile.json"), Charsets.UTF_8);
    ...
    public void test_aggregator_sampling_unit_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-aggregators-sampling-unit.json"), Charsets.UTF_8);
    ...
    public void test_groupby_missingName_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-no-name.json"), Charsets.UTF_8);
    ...
    public void test_groupby_emptyName_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-empty-name.json"), Charsets.UTF_8);
    ...
    public void test_groupby_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by.json"), Charsets.UTF_8);
    ...
    public void test_groupby_tag_missing_tags_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-tag-missing-tags.json"), Charsets.UTF_8);
    ...
    public void test_groupby_time_missing_range_size_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-time-missing-range_size.json"), Charsets.UTF_8);
    ...
    public void test_groupby_time_range_size_value_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-time-range_size_value.json"), Charsets.UTF_8);
    ...
    public void test_groupby_time_range_size_unit_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-time-range_size_unit.json"), Charsets.UTF_8);
    ...
    public void test_groupby_time_missing_group_count_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-time-missing-group_count.json"), Charsets.UTF_8);
    ...
    public void test_groupby_value_range_size_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-query-metric-group_by-value-range_size.json"), Charsets.UTF_8);
    ...
    public void test_parseRollUpTask_no_execution_interval_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-rollup-no-execution_interval.json"), Charsets.UTF_8);
    ...
    public void test_parseRollUpTask_empty_query_time_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-rollup-no-query_time.json"), Charsets.UTF_8);
    ...
    public void test_parseRollUpTask_noRangeAggregator_invalid() throws IOException, QueryException {
        final String json = Resources.toString(Resources.getResource("invalid-rollup-no-range-aggregator.json"), Charsets.UTF_8);
    ...
    public void test_parseRollupTasks() throws IOException, QueryException {
        ...
        final List<RollupTask> tasks = parser.parseRollupTasks(json);

        assertThat(tasks.size(), equalTo(2));

        final RollupTask rollupTask1 = tasks.get(0);
        ...
        final RollupTask rollupTask2 = tasks.get(1);
    ...
    private void assertRollupBeanValidation(final String json, final String expectedMessage) {
        try {
    ...
    private void assertBeanValidation(final String json, final String expectedMessage) {
        try {
            parser.parseQueryMetric(json);
            fail("Expected BeanValidationException");
        } catch (final QueryException e) {
    ...
    private void assertRollup(final Rollup rollup, final int queryCount, final String metricName, final String saveAsName, final Aggregator... aggregators) {
        assertThat(rollup.getSaveAs(), equalTo(saveAsName));
        assertThat(rollup.getQueryMetrics().size(), equalTo(queryCount));

        final QueryMetric query = rollup.getQueryMetrics().get(0);
     ...
     */
    private void assertHasSaveAsAggregator(final List<Aggregator> aggregators, final SaveAsAggregator expected) {
        int saveAsAggregatorCount = 0;
        for (final Aggregator aggregator : aggregators) {
            if (aggregator instanceof SaveAsAggregator) {
                saveAsAggregatorCount++;
                final SaveAsAggregator actual = (SaveAsAggregator) aggregator;
     ...
     * Don't love this approach but equals/hashcode for Aggregators is problematic.
     */
    private void assertHasSumAggregator(final List<Aggregator> aggregators, final SumAggregator expected) {
        int aggregatorCount = 0;
        for (final Aggregator aggregator : aggregators) {
            if (aggregator instanceof SumAggregator) {
                aggregatorCount++;
                final SumAggregator actual = (SumAggregator) aggregator;
    ...
    private SaveAsAggregator createSaveAsAggregator(final String metricName, final List<String> groupBys) {
        final SaveAsAggregator aggregator = new SaveAsAggregator(eventBus);
    ...
    private TrimAggregator createTrimAggregator(final TrimAggregator.Trim trim) {
        return new TrimAggregator(trim);
    }

    private SumAggregator createSumAggregator(final Sampling sampling) {
        final SumAggregator aggregator = new SumAggregator(new DoubleDataPointFactoryImpl());
