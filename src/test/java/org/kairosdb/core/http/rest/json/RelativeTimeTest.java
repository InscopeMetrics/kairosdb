...
public class RelativeTimeTest {
    ...
    public void test_getTimeRelativeTo_invalidUnit() throws KairosDBException {
        final RelativeTime time = new RelativeTime(5, "QUARTERS");
    ...
    public void test_getTimeRelativeTo_milliseconds() throws ParseException {
        final RelativeTime time = new RelativeTime(5, "MILLISECONDS");
    ...
    public void test_getTimeRelativeTo_seconds() throws ParseException {
        final RelativeTime time = new RelativeTime(5, "SECONDS");
    ...
    public void test_getTimeRelativeTo_minutes() throws ParseException {
        final RelativeTime time = new RelativeTime(5, "MINUTES");
    ...
    public void test_getTimeRelativeTo_hours() throws ParseException {
        final RelativeTime time = new RelativeTime(3, "HOURS");
    ...
    public void test_getTimeRelativeTo_days() throws ParseException {
        final RelativeTime time = new RelativeTime(3, "DAYS");
    ...
    public void test_getTimeRelativeTo_weeks() throws ParseException {
        final RelativeTime time = new RelativeTime(3, "WEEKS");
    ...
    public void test_getTimeRelativeTo_Months() throws ParseException {
        final RelativeTime time = new RelativeTime(2, "MONTHS");
    ...
    public void test_getTimeRelativeTo_years() throws ParseException {
        final RelativeTime time = new RelativeTime(3, "YEARS");
    ...
    public void testValueZeroInvalid() {
        final RelativeTime time = new RelativeTime(0, "days");
        final Set<ConstraintViolation<RelativeTime>> violations = BeanValidationHelper.VALIDATOR.validate(time);
    ...
    public void testUnitNullInvalid() {
        final RelativeTime time = new RelativeTime();
        final Set<ConstraintViolation<RelativeTime>> violations = BeanValidationHelper.VALIDATOR.validate(time);
        final List<String> violationMessages = BeanValidationHelper.messagesFor(violations);
