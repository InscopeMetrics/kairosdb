...
public class HealthCheckResourceTest {
    ...
    public void setup() throws DatastoreException {
        ...
        final HealthCheckService healthCheckService = new TestHealthCheckService();
    ...
    public void testCheckAllHealthy() {
        final Response response = resourceService.check();
    ...
    public void testStatusAllHealthy() {
        final Response response = resourceService.status();
