...
public class GroupTest {
    ...
    public void test() throws IOException {
        final KairosDataPointFactory kairosDataPointFactory = new TestDataPointFactory();
        final ListDataPointGroup dataPointGroup = new ListDataPointGroup("TestGroup");
        ...
        final Group group = Group.createGroup(dataPointGroup, groupIds, Collections.emptyList(), kairosDataPointFactory);

        group.addDataPoint(new LongDataPoint(1, 1));
        group.addDataPoint(new LongDataPoint(2, 2));

        final DataPointGroup cachedGroup = group.getDataPointGroup();
