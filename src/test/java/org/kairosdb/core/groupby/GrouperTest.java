...
public class GrouperTest {
    ...
    public static void assertDataPoint(final DataPoint dataPoint, final long expectedTimestamp, final long expectedValue) {
    ...
    public void test() throws IOException, FormatterException {
        final Grouper grouper = new Grouper(new TestDataPointFactory());

        final List<GroupBy> groupBys = new ArrayList<GroupBy>();
        groupBys.add(new ValueGroupBy(3));
        groupBys.add(new SimpleTimeGroupBy(2));

        final ListDataPointGroup dataPointGroup1 = new ListDataPointGroup("dataPointGroup1");
        ...
        final ListDataPointGroup dataPointGroup2 = new ListDataPointGroup("dataPointGroup2");
        ...
        final List<DataPointGroup> groups = grouper.group(groupBys, dataPointGroups);

        assertThat(groups.size(), equalTo(5));

        // Group 1
        final DataPointGroup group1 = groups.get(0);
        ...
        // Group 2
        final DataPointGroup group2 = groups.get(1);
        ...
        // Group 3
        final DataPointGroup group3 = groups.get(2);
        ...
        // Group 4
        final DataPointGroup group4 = groups.get(3);
        ...
        // Group 5
        final DataPointGroup group5 = groups.get(4);
