...
public class TournamentTreeTest {
    ...
    private class RowData {
        ...
        public RowData(final long ts, final int value) {
            m_ts = ts;
            m_value = value;
        }
    ...
    private class RowDataComparator implements Comparator<RowData> {
        public int compare(final RowData rd1, final RowData rd2) {
